...
data class HistorySchedulesLstRes(

    @field:SerializedName("data")
    val data: ArrayList<HistoryScheduleDataItem?>? = null,
...
data class HistoryScheduleChapterDetails(
...
data class HistoryScheduleDataItem(
    ...
    val chapterDetails: HistoryScheduleChapterDetails? = null,
