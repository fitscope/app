...
data class SaveChapterLstRes(

    @field:SerializedName("data")
    val data: ArrayList<SaveChapterDataItem?>? = null,
...
data class SaveChapterDataItem(
    ...
    val fitScopeData: SavedFitScopeData? = null,
