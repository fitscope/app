...
import com.mobulous.pojo.library.FavChapterDataItem
import com.mobulous.pojo.library.FavChaptersItem

class SingleViewChaptersAptr(val con: Context, val lst: ArrayList<FavChaptersItem?>) :
    RecyclerView.Adapter<SingleViewChaptersAptr.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SingleViewChaptersAptr.ViewHolder {
        return ViewHolder(
    ...
    override fun onBindViewHolder(holder: SingleViewChaptersAptr.ViewHolder, position: Int) {
