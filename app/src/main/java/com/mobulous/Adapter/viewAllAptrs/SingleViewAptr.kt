...
class SingleViewAptr(val con: Context, val lst: ArrayList<ProgramChaptersDataItem?>) :
    RecyclerView.Adapter<SingleViewAptr.ViewHolder>() {
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): SingleViewAptr.ViewHolder {
        return ViewHolder(
    ...
    override fun onBindViewHolder(holder: SingleViewAptr.ViewHolder, position: Int) {
