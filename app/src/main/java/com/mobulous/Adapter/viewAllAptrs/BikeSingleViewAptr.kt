...
class BikeSingleViewAptr(val con: Context, val lst: ArrayList<CommonChaptersItem?>) :
    RecyclerView.Adapter<BikeSingleViewAptr.ViewHolder>() {
    override fun onCreateViewHolder(
        parent: ViewGroup,
        viewType: Int
    ): BikeSingleViewAptr.ViewHolder {
        return ViewHolder(
    ...
    override fun onBindViewHolder(holder: BikeSingleViewAptr.ViewHolder, position: Int) {
